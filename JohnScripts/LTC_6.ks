...
PARAMETER targetApoapsis is 80.
PARAMETER targetInclination IS - 6. 
...
PARAMETER turnStart IS 1000.
// Staging delays (time after detection of engine shutdown before staging or between staging actions)
SET boosterStageDelay TO 1.	// ***** was 2
SET stageDelay TO 1. // Should be greater than 1 to prevent problems. **** was 3
