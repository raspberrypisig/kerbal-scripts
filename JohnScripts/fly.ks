...
FUNCTION TAKEOFF {
    ...
    SAS OFF.
    BRAKES OFF.
	//SET STEERING TO HEADING(90,0).    //   ***************  JS
    STAGE.
    SET SHIP:CONTROL:PILOTMAINTHROTTLE TO 1.
    WAIT UNTIL SHIP:AIRSPEED > 50.
    SET SHIP:CONTROL:PITCH TO 0.5.
    WAIT UNTIL SHIP:Altitude > LANDEDALT + 25.
...
SET buttonWP01:ONCLICK TO 
    {
        set TargetCoord to latlng(-0.0483334,-75.009999). // RWY 09 *****JS orig -74.724722
...
//Runways coordinates
SET RWYKSC to latlng(-0.04807,-74.745).     //    ******* JS   orig -74.65
...
ELSE IF KindOfCraft = "Plane" {
    ...
    SET TargetCoord TO TGTRunway.
    SET LabelWaypoint:Text TO "KSC Runway 09".
    SET FLAREALT TO 70.      //  ***************    JS orig 100
}
