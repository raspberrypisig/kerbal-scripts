...
// rescue co-ordsrun spotmunmohanarch
set landing_pos to LATLNG( 2.463069000,  81.5308329  ).
clearscreen.
clearvecdraws().
...
function Vmax_v {
	declare parameter buffer_terrain is 0, TouchDownSpeed is 2.
...
until ship:status = "LANDED" {
	...
	print "Longitude = " +round(ship:geoposition:lng,7) at(0,0).
	print "Latitude = " +round(ship:geoposition:lat,7) at(0,1).
	...
	print "V_throttle = " + round(100*(VDOT(V_vec,throttle_vec)),1) + "%   "at(0,7).
	print "H_throttle = " +round(100*(VDOT(H_vec,throttle_vec)),1) + "%   " at(0,8).
	print "S_throttle = " +round(100*(VDOT(S_vec,throttle_vec)),1) + "%   " at(0,09).
...
//	print "Vertical speed = " +round(verticalspeed,2) at(0,25).
//	print "TouchDown Speed= " +  round(touchdown_speed,2) at (0,26).
//   print "True Altitude= " + round(true_alt,2) at (0,27). 
// 	print "Altitude Cutoff= " + round(alt_cutoff,2) at (0,28).	
//	print "TouchDown_Mode = " + TouchDown_Mode + "   " at(0,29).
//	print "Follow_Mode = " + Follow_Mode + "   " at(0,30).
//	print "Line 186 = " + sqrt(V_throttle^2 + H_throttle_test^2 + S_throttle_test^2) + " " at (0,31).
//	print "throttle_hyst = " + throttle_hyst + "   " at(0,32).	
//	print "left_over_flag = " + left_over_flag + "   " at(0,33).	
	
//	if defined left_over{
//	print "left_over = " + left_over + "   " at(0,35).
//	}
