...
// rescue co-ords
//set landing_pos to LATLNG(-27.43944444,0.48111111).
//https://www.latlong.net/degrees-minutes-seconds-to-decimal-degrees
// Tedvey's LATLNG  0.11.40 N - 97.51.1 E convert to decimal and insert in next line?
// Deshat's LATLNG (-) 40.28.15 S - 0.34.34 E
// Minmus Zone 28VT LATLNG 29.155203844382061, - 3.9477605627397732
// Deimone on Mun 0.19444444, 97.88277778
// MunHab1 on Mun (0.192155, 97.8821177)
// On Top of Muns' Arch ( 2.4630550,  81.5308330  ) Beside the arch  2.46305556 N 81.53083333 E 
// Kerbin space port    (- 0.098, - 74.55)  test

set landing_pos to LATLNG( - 0.098000, - 74.550000).
clearscreen.
clearvecdraws().
